...
import cv from '../../assets/img/mct-badge.png';
import da from '../../assets/img/da-cert.png';
  ...
  render() {
    ...
    return (
      ...
      <Roll right>
        ...
        <Flip right>
        <div>
          <img src={cv} onClick={() => this.setState({ isOpen: true })} className="cv_img_mouse" alt="Joshua Michalik CV preview"/>
            {isOpen && (
                <Lightbox
